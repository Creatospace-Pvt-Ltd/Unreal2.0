...
void AOnlinePlayerController::AcceptOnlineClient(FString ClientID)
{
...
void AOnlinePlayerController::TerminateOnlineGameSession()
{
    FGameLiftServerSDKModule* gameLiftSdkModule = &FModuleManager::LoadModuleChecked<FGameLiftServerSDKModule>(FName("GameLiftServerSDK"));
...
void AOnlinePlayerController::RemoveOnlinePlayerSession(FString SessionId)
{
    FGameLiftServerSDKModule* gameLiftSdkModule = &FModuleManager::LoadModuleChecked<FGameLiftServerSDKModule>(FName("GameLiftServerSDK"));
...
void AOnlinePlayerController::ManageNewOnlinePlayer(APlayerController* NewPlayer)
{
