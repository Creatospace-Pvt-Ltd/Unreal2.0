...
class DLB_COMMS_EXPORT device_management {
 public:
   ...
   *
   * @warning This is an experimental functionality, which should not be used for general-purpose application feature
   * development. Changing the input device's volume may affect echo cancellation performance, will interfere with
   * automatic gain adjustment, and will change the system volume of the input device.
   *
   * @returns The result object producing the operation status asynchronously.
   */
   ...
   *
   * @warning This is an experimental functionality, which should not be used for general-purpose application feature
   * development. Changing the output device's volume may affect echo cancellation performance, will interfere with
   * automatic gain adjustment, and will change the system volume of the output device.
   *
   * @returns The result object producing the operation status asynchronously.
   */
  ...
  /**
   * @brief Get a list of all possible Screen Sharing sources. This can be both entire
   * monitor screens or specific active application windows.
   *
   * @returns The result object producing the screen share source list asynchronously.
   * \code{.cpp}
   * // Wait device to be set
   ...
   *
   * @returns The result object producing the screen share source asynchronously.
   * #async_result fails if no screen share source is set.
   * \code{.cpp}
   * // Wait device to be set
