...
struct DLB_COMMS_EXPORT spatial_position {
   ...
   */
  constexpr spatial_position(double x, double y, double z) : x(x), y(y), z(z) {}
...
struct DLB_COMMS_EXPORT polar_position {
   ...
   */
  constexpr polar_position(double azimuth, double elevation, double distance)
...
// spatial_direction moved to media_engine.h
...
struct DLB_COMMS_EXPORT spatial_scale {
   ...
   */
  constexpr spatial_scale(double x, double y, double z) : x(x), y(y), z(z) {}
...
class DLB_COMMS_EXPORT spatial_audio_batch_update {
 public:
  ...
  struct environment {
     ...
     * forward and up.
     */
    constexpr environment(const spatial_scale& scale,
