...
class sdk_interactions : public interactor, public sdk_interactor_common {
 public:
  struct initial_params {
    ...
    struct conf {
      ...
      std::optional<dolbyio::comms::video_forwarding_strategy> forward_startegy;
    ...
    conf conf;
    std::shared_ptr<dolbyio::comms::video_frame_handler> video_frame_handler{};
  };
 ...
 private:
  ...
  dolbyio::comms::event_handler_id audio_levels_{};
};
